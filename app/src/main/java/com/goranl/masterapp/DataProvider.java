...
public class DataProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI_MESSAGES = Uri.parse("content://com.goranl.masterapp.provider/messages");
	public static final Uri CONTENT_URI_PROFILE = Uri.parse("content://com.goranl.masterapp.provider/profile");
	...
	static {
		...
		uriMatcher.addURI("com.goranl.masterapp.provider", "messages", MESSAGES_ALLROWS);
		uriMatcher.addURI("com.goranl.masterapp.provider", "messages/#", MESSAGES_SINGLE_ROW);
		uriMatcher.addURI("com.goranl.masterapp.provider", "profile", PROFILE_ALLROWS);
		uriMatcher.addURI("com.goranl.masterapp.provider", "profile/#", PROFILE_SINGLE_ROW);
	}
